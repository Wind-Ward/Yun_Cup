...
train_data =['./output/train_segment_220000_v11_modify_processed_stopword_translate_modify.txt',"./output/test_segment_50000_v11_modify_processed_stopword_translate_modify.txt",\
             "./output/test_segment_a_30000_v11_modify_processed_stopword_translate_modify.txt"]
...
model=word2vec.Word2Vec(train_corpus, min_count=1, workers=12,size=200,iter=50)
model.save('./word2vec_v2_200_ndim.model')


train_num=220000
test_num=50000
total=train_num+test_num
train_arrays=np.zeros((train_num,200))
test_arrays=np.zeros((test_num,200))
...
t.to_csv("./output/train_22w_custom_word2vec_v2_200_ndim.csv",index=False,header=None)

t=pd.DataFrame(test_arrays)
t.to_csv("./output/test_5w_custom_word2vec_v2_200_ndim.csv",index=False,header=None)
